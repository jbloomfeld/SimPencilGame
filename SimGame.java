...
/*
 * File: SimGame.java
 * Purpose: This is a version of the Sim Pencil Game;
 *     it draws the game on  an 800x800 window and allows the user to 
 * Date: 4/21/14
 * Class: CS 112
 *
 * Author: Jake Bloomfeld
 */
...
public class SimGame{ 
   ...
   public static void main(String args[]){ 
      ...
      // Use the next line after creating your Graph class to test it
      // when you write your player class, substitute the following line.
      ...
      int x0 = 0;
      int y0 = 0; 
      int maxRounds = numCircles*(numCircles-1)/2;
